...
set "H_URL=https://raw.githubusercontent.com/aveoxfd/winwindow/main/headers/winwindow.h"
...
if not "%REMOTE_VERSION%"=="%LOCAL_VERSION%" (
    ...
    del "%CD%\header\winwindow.h"
    curl.exe -s -L -o "%CD%\header\winwindow.h" "%H_URL%"
    if errorlevel 1 (
